...
int cosa;
int Serialisimo::variable()
{   //return 1;
    //int cosa;
    //if(BacklightController::m_variable==1)  {cosa=1;}
    //if(BacklightController::m_variable==0)  {cosa=0;}
...
{
    //int cosa=BacklightController::m_variable;
    //int cosa=1;
    //int hola=1;
    if(cosa==1){cosa=0;}
...
void Serialisimo::enviarmodulo(int cto,int estado)
{
